...
#define PRODUCT_ID      0x4160 // Apollo
#define DEVICE_VER      0x0001 // Revision pre-Alpha
#define MANUFACTURER    AcheronProject
#define PRODUCT         Apollo87HV1

/* key matrix size */
#define MATRIX_ROWS 6
#define MATRIX_COLS 17

#define MATRIX_COL_PINS { A9 , A8 , B14, B12, B11, B10, B2 , B1 , B0 , A6 , A5 , A4 , A10, A3 , A2 , A1 , F0}
#define MATRIX_ROW_PINS { B4 , B3 , A15, A7 , A0 , F1 }
